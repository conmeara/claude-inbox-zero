...
const DraftReview = ({ emails, onComplete, onBack, inboxService, debug = false, preInitializedAiService, preInitializedQueueManager, preInitializedGenerationQueue, preInitializedRefinementQueue }) => {
    ...
    return (React.createElement(Box, { flexDirection: "column", paddingY: 1 },
        ...
        React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
            ...
            React.createElement(Box, { marginTop: 1 }, currentItem.summary ? (React.createElement(Text, null, currentItem.summary)) : (React.createElement(Text, { color: "gray" },
                React.createElement(Spinner, { type: "dots" }),
                " Generating summary...")))),
        currentItem.draft ? (React.createElement(React.Fragment, null,
            ...
            React.createElement(Box, { flexDirection: "column", marginTop: 1 },
                ...
                React.createElement(Box, { marginTop: 1 },
                    React.createElement(Text, { color: "gray" }, "[Tab] Accept  [\u21E7Tab] Skip  [\u2318\u2190\u2192] Navigate  [^E] Manual Edit  [Esc] Clear")),
            ...
            React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(Text, { color: "gray" }, "This email is informational only - no response needed.")),
            React.createElement(Box, { flexDirection: "column", marginTop: 1 },
                React.createElement(Text, { color: "gray" }, "[Tab] Accept  [\u21E7Tab] Skip  [\u2318\u2190\u2192] Navigate")))),
