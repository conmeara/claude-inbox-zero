...
const DraftReview = ({ emails, onComplete, onBack, inboxService, debug = false, concurrency = 10, preInitializedAiService, preInitializedQueueManager, preInitializedGenerationQueue, preInitializedRefinementQueue }) => {
    ...
    return (React.createElement(Box, { flexDirection: "column", paddingY: 1 },
        React.createElement(Box, { marginBottom: 1, flexDirection: "column" },
            React.createElement(Box, null,
                React.createElement(Text, { bold: true }, "Email Review "),
                React.createElement(Text, { color: getStateColor(currentItem.state) }, "\u25CF "),
                React.createElement(Text, { color: getStateColor(currentItem.state) }, getStateLabel(currentItem.state))),
        ...
        currentItem.state === 'refined' && (React.createElement(Box, { marginBottom: 1 },
            React.createElement(Text, { color: "green" }, "\u25CF Refined based on your feedback"),
        ...
        React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
            React.createElement(Box, null,
                ...
                React.createElement(Text, { bold: true }, currentItem.email.from.name)),
            React.createElement(Box, null,
                React.createElement(Text, { color: "gray" }, "\u25CF Subject: "),
                React.createElement(Text, null, currentItem.email.subject)),
            React.createElement(Box, null,
                React.createElement(Text, { color: "gray" }, "\u25CF Date: "),
                React.createElement(Text, { color: "gray" }, formatDate(currentItem.email.date)))),
        React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
            React.createElement(Box, null,
                React.createElement(Text, { color: currentItem.summary ? "green" : "yellow" }, "\u25CF "),
                React.createElement(Text, { bold: true }, "Summary")),
            React.createElement(Box, { marginTop: 1, marginLeft: 2 }, currentItem.summary ? (React.createElement(Text, null, currentItem.summary)) : (React.createElement(Text, { color: "gray" },
                React.createElement(Spinner, { type: "dots" }),
                " Generating summary...")))),
        currentItem.draft ? (React.createElement(React.Fragment, null,
            currentItem.conversationHistory && currentItem.conversationHistory.length > 0 ? (React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(Box, null,
                    React.createElement(Text, { color: "green" }, "\u25CF "),
                    React.createElement(Text, { bold: true }, "Draft Reply")),
                React.createElement(Box, { flexDirection: "column", marginTop: 1, marginLeft: 2 }, currentItem.conversationHistory.map((entry, index) => (React.createElement(Box, { key: index, flexDirection: "column", marginBottom: 1 },
                    entry.type === 'draft' && (React.createElement(React.Fragment, null,
                        index > 0 && (React.createElement(Box, { marginBottom: 1 },
                            React.createElement(Text, { color: "green" }, "\u25CF "),
                            React.createElement(Text, { color: "green" },
                                "Draft ",
                                Math.floor(index / 2) + 1))),
                        React.createElement(Text, null, entry.content))),
                    entry.type === 'user' && (React.createElement(Box, { marginTop: 1 },
                        React.createElement(Text, { color: "cyan" }, "> "),
                        React.createElement(Text, { color: "cyan" }, entry.content))),
                    entry.type === 'refinement' && (React.createElement(React.Fragment, null,
                        React.createElement(Box, { marginTop: 1, marginBottom: 1 },
                            React.createElement(Text, { color: "green" }, "\u25CF "),
                            React.createElement(Text, { color: "green" }, "Refined Draft")),
                        React.createElement(Text, null, entry.content))))))))) : (React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(Box, null,
                    React.createElement(Text, { color: "green" }, "\u25CF "),
                    React.createElement(Text, { bold: true }, "Draft Reply")),
                React.createElement(Box, { marginTop: 1, marginLeft: 2 },
                    React.createElement(Text, null, currentItem.draft.draftContent)))),
            React.createElement(Box, { flexDirection: "column", marginTop: 1 },
                ...
                React.createElement(Box, { marginTop: 1 },
                    React.createElement(Text, { color: "gray" }, "[Tab] Accept  [\u21E7Tab] Skip  [\u2318\u2190\u2192] Navigate  [^E] Manual Edit  [Esc] Clear"))))) : currentItem.email.requiresResponse ? (React.createElement(React.Fragment, null,
            React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(Box, null,
                    React.createElement(Text, { color: "yellow" }, "\u25CF "),
                    React.createElement(Text, { bold: true }, "Draft Reply")),
            ...
            React.createElement(Box, { flexDirection: "column", marginTop: 1 },
                ...
                React.createElement(Text, { color: "gray" }, "(Draft will be ready shortly)")))) : (React.createElement(React.Fragment, null,
            React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(Box, null,
                    React.createElement(Text, { color: "gray" }, "\u25CF "),
                    React.createElement(Text, { color: "gray" }, "No response needed")),
                React.createElement(Box, { marginTop: 1, marginLeft: 2 },
